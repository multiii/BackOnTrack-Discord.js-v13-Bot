...
class Args {
    ...
    missingArguments() {
        return (0, result_1.err)(new UserError_1.UserError({ identifier: "argsMissing" /* Identifiers.ArgsMissing */, message: 'There are no more arguments.', context: this.toJSON() }));
    }
    /**
