...
class CoreListener extends Listener_1.Listener {
    constructor(context) {
        super(context, { event: Events_1.Events.PossibleContextMenuCommand });
    }
    run(interaction) {
        ...
        if (!command) {
            client.emit(Events_1.Events.UnknownContextMenuCommand, {
                interaction,
        ...
        if (!command.contextMenuRun) {
            client.emit(Events_1.Events.CommandDoesNotHaveContextMenuCommandHandler, {
                command,
                interaction,
                context: { commandId: interaction.commandId, commandName: interaction.commandName }
            });
        ...
        client.emit(Events_1.Events.PreContextMenuCommandRun, {
            command: command,
            context: { commandId: interaction.commandId, commandName: interaction.commandName },
            interaction
        });
